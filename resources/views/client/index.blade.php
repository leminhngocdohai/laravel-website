...
<div class="colorlib-shop">
    <div class="container">
        ...
        <div class="row">
            @foreach ($products_featured as $pf)
            <div class="col-md-3 text-center">
                <div class="product-entry">
                    <div class="product-img" style="background-image: url(../upload/image/{{$pf->image}});">
                        <div class="cart">
                            <p>
                                <span class="addtocart"><a href="cart.html"><i
                                            class="icon-shopping-cart"></i></a></span>
                                <span><a href="{{route('product.detail',['slug'=>$pf->slug])}}"><i class="icon-eye"></i></a></span>
                    ...
                    <div class="desc">
                        <h3><a href="{{route('product.detail',['slug'=>$pf->slug])}}">{{$pf->name}}</a></h3>
                        <p class="price"><span>{{number_format($pf->price)}}</span></p>
                    </div>
                </div>
            </div>
            @endforeach
            ...
            <div class="col-md-3 text-center">
                <div class="product-entry">
                    ...
                    <div class="desc">
                        ...
                        <p class="price"><span>{{number_format($ps->price)}}</span></p>
                    </div>
                </div>
            </div>
            @endforeach
