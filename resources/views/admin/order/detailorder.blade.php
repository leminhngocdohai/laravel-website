...
@section('title','Vietpro Detail Order')
@section('content')
                        ...
                        <div class="bootstrap-table">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" style="margin-top:20px;">
                                    ...
                                    <tbody>
                                        @foreach ($order->products_order as $key => $p_r)
                                        <tr>
                                            <td>{{$key}}</td>
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img width="100px" src="../upload/image/{{$p_r->image}}" class="thumbnail">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <p><b>Mã sản phẩm</b>: {{$p_r->code}}</p>
                                                        <p><b>Tên Sản phẩm</b>: {{$p_r->name}}</p>
                                                        <p><b>Số lương</b> : {{$p_r->quantity}}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{number_format($p_r->price)}}</td>
                                            <td>{{number_format($p_r->price*$p_r->quantity)}}</td>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <h4 align='right' style="color: brown;">{{$order->total}}</h4>
                                            </th>
                                ...
                                <div class="alert alert-primary" role="alert" align='right'>
                                    <a class="btn btn-success" href="{{route('order.update',['id'=>$order->id])}}" role="button">Đã xử lý</a>
                                </div>
                            </div>
                        </div>
